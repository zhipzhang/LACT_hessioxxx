...
Copyright (C) 2006, 2007, 2009, 2010, 2011, 2012, 2018, 2022  Konrad Bernloehr
...
void syntax (char * prgm)
{
   fprintf(stderr,"Generate image shape and energy lookups for user analysis in read_hess.\n\n");
