...
Copyright (C) 2003, 2004, 2005, 2006, 2007, 2010, 2012, 2014, 2016, 2018 Konrad Bernloehr (Konrad Bernl&ouml;hr)
...
# endif
   ...
   fprintf(stderr,"Default byte order, using single-element functions.\n");
   memset((void*)&cdata1,0,sizeof(cdata1));
   if ( iobuf.Find() < 0 )
   {
   ...
   fprintf(stderr,"Default byte order, using mainly vector functions.\n");
   memset((void*)&cdata2,0,sizeof(cdata2));
   if ( iobuf.Find() < 0 )
   {
