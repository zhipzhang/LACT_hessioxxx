/* ============================================================================
   ...
   Copyright (C) 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2014, 2016, 2018, 2023 Konrad Bernloehr (Konrad Bernl&ouml;hr)
...
EventIO::EventIO (UNUSED_PAR2(const EventIO& ,eventio) /* unused, throw logic error if called */) :
   iobuf(0), toplevel(0), input_fname(""), output_fname(""),
   local_input(false), local_output(false), throw_on_error(false),
   external_buffer(false)
{ 
...
EventIO& EventIO::operator= (UNUSED_PAR2(const EventIO&, eventio) /* unused, throw logic error if called */)
{
...
EventIO::Item::Item (UNUSED_PAR2XX(const EventIO::Item&, eventio) /* unused, throw logic error if called */) :
   iobuf(0), rc(-1), 
...
EventIO::Item& EventIO::Item::operator= (UNUSED_PAR2XX(const EventIO::Item&, item) /* unused, throw logic error if called */ )
