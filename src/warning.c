/* ============================================================================
   ...
   Copyright (C) 2001, 2003, 2006, 2007, 2008, 2009, 2010, 2014, 2018, 2022, 2023  Konrad Bernloehr
...
static void warn_destructor ( UNUSED_PAR2(void *,whatever) )
{
   ...
   int msglevel, int msgno)
{
   ...
   flush_output(); /* Help keeping stdout and stderr separate. */
...
/**
 *  @short Set an auxiliary function for warnings. 
