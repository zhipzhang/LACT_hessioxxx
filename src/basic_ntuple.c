...
Copyright (C) 2009, 2010, 2018, 2023  Konrad Bernloehr
...
/**
   @file basic_ntuple.c
   @brief Print specific ntuple data from read_hess shower analysis.
...
int list_ntuple(FILE *f, const struct basic_ntuple *b, int wtr)
{
   ...
   if ( ! list_init )
   {
    ...
    if ( with_true )
    {
      ...
      fprintf(f,"# Separator '|', followed by auxiliary reconstructed data:\n");
