/* ============================================================================
   ...
   Copyright (C) 1993, 2001, 2007, 2010, 2021, 2023  Konrad Bernloehr
...
#if ! defined WITH_BOOL && ! defined __cplusplus && ! defined bool
typedef unsigned char bool; /* Work-around if we have no 'bool' variable type */
#endif
...
struct ConfigIntern
{
   ...
   int rcount;           /**< Reconfiguration count. */
