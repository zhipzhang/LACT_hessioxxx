...
Copyright (C) 2006, 2007, 2009, 2010, 2011, 2013, 2014, 2015, 2016, 2017, 2019, 2022, 2023  Konrad Bernloehr
...
/** @file user_analysis.h
 *  @short Pass data between hessio main program (read_hess) and analysis code.
 *
 *  @author  Konrad Bernloehr 
 *  @date    2006 to 2023
 */

#ifndef USER_ANALYSIS_H__LOADED
#define USER_ANALYSIS_H__LOADED 1
