/* ============================================================================
   ...
   Copyright (C) 2003, 2004, 2005-2011, 2014, 2016, 2018, 2019, 2021 Konrad Bernloehr (Konrad Bernl&ouml;hr)
...
//               else check_throw("Put"); }
      ...
      public:
         ...
         size_t Length(void) const { return size(); }
         EventIO& SetMaxSize(size_t max_size) { iobuf->max_length = max_size; return *this; }
         /// Extract input and output
         FILE *InputFile() { return iobuf->input_file; }
         FILE *OutputFile() { return iobuf->output_file; }
         /// Open input file
