/* ============================================================================
   ...
   Copyright (C) 1991, 2001, 2008, 2009, 2010, 2016, 2018, 2023  Konrad Bernloehr
...
/* The stdbool.h header file is specified by C99 (and up) but might be available anyway. */ 
#ifdef __cplusplus
# define WITH_BOOL 1
#else
# if defined(ANSI_C_99)
#  include <stdbool.h>
#  define WITH_BOOL 1
# else 
#  ifdef __has_include
